...
def main():
    ...
    ccc_car_keys_param = CCCSessionParam(session_id=0x12345678, device_type=EnumCCCDeviceType.CCC_DEVICE_TYPE_CONTROLEE.value, uwb_config_id=0,
                                    device_role=EnumCCCDeviceRole.CCC_DEVICE_ROLE_RESPONDER.value, anchor_num=1, sts_index0=0x075BCD15, slots_per_rr=12, ranging_interval=960, ccc_config_quirks=1,
    ...
    # ccc_car_keys_param.ranging_round_usage = 6
